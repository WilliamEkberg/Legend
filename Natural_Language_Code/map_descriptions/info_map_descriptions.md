...
- 2026-03-05 :: william :: Updated all 3 LLM prompts to instruct newline usage in detail fields. Examples now show `\n`-separated points instead of semicolon-joined run-on text. LLM context renderer updated to split detail on newlines for multi-line blockquotes.
